...
router.route('/')
    ...
    .post((0, middlewares_1.isAuthorized)(access_1.manageModel), (0, express_async_handler_1.default)(controllers_1.modelCtrl.addModel));
router.route('/:_id')
    ...
    .delete((0, middlewares_1.isAuthorized)(access_1.manageModel), (0, express_async_handler_1.default)(controllers_1.modelCtrl.deleteModel));
